...
exports.default = [
    {
        ...
        description: 'On the night of February 2nd 2010 I infiltrated into McDonalds head quarters to get my hands on the secret formula. After months of planning the perfect heist I successfully retrieved the recipe. But McDonalds is now after me so I will release it to the public!',
        ingredients: [
            {
    ...
    },
    {
        ...
        description: 'I love Chirashi so much that I will legally make my middle name Chirashi. After this recipe, I will be known as Ivan Chirashi Don Tang. This recipe is for making sushi rice as the toppings can be anything you want!',
        ingredients: [
            {
    ...
    },
    {
        ...
        description: "I also love a good chirashi don but I thought it might give it a little extra flavor if you put in kombu when you're cooking the rice!",
        ingredients: [
            {
                ingredient: 'Japanese short grain rice',
                amount: '2',
    ...
    },
    {
        ...
        description: "This recipe can also be done with spaghetti! It's commonly done in Hong Kong style cafes!",
        ingredients: [
            {
    ...
    },
    {
        ...
        description: 'Also a common Hong Kong cafe dish, you can change the sauce to a tomato-based sauce if you are not a fan of the coconut curry sauce! This dish has pork chops instead of chicken and a nice tangy tomato sauce instead of creamy coconut curry.',
        ingredients: [
            {
    ...
    },
    {
        ...
        instructions: 'Put butter into a small sauce pan on a medium to low flame. Once the butter has melted pour in the heavy cream and allow to simmer. Gently stir to avoid over boiling.',
        photo: 'alfredo.jpg',
    },
    {
        ...
        ownerId: '61e607f0311d699fd35f509e',
        title: 'Add Pepper',
        description: 'Building on the previous fork, I decided to add an ungodly amount of pepper to the sauce.',
        ingredients: [
            { ingredient: 'heavy cream', amount: 100, unitOfMeasure: 'ml' },
            { ingredient: 'butter', amount: 0.25, unitOfMeasure: 'cups' },
            { ingredient: 'fine ground black pepper', amount: 4, unitOfMeasure: 'table spoons' },
        ],
        instructions: 'Put butter into a small sauce pan on a medium to low flame. Once the butter has melted pour in the heavy cream and allow to simmer. Gently stir to avoid over boiling. Add the black pepper to the sauce and stir well to evenly distribute the pepper in the sauce',
        photo: 'alfredo.jpg',
    },
    {
        ...
        description: 'Reducing the amount of pepper in the sauce and adding minced/chopped garlic to the sauce!',
        ingredients: [
            { ingredient: 'heavy cream', amount: 100, unitOfMeasure: 'ml' },
            { ingredient: 'butter', amount: 0.25, unitOfMeasure: 'cups' },
        ...
        instructions: 'Finely chop or mince garlic cloves. Put butter into a small sauce pan on a medium to low flame. Once the butter has melted add the garlic and leave until fragrent. Once the garlic is fragrent, pour in the heavy cream and allow to simmer. Gently stir to avoid over boiling. Add the black pepper to the sauce and stir well to evenly distribute the pepper in the sauce',
        photo: 'alfredo.jpg',
    },
    {
        ...
        description: "This is the recipe my asian grandmother used to make for us. This technically makes no sense because I doubt she would make a alfredo sauce but hey I don't make the rules.",
        ingredients: [
            { ingredient: 'heavy cream', amount: 100, unitOfMeasure: 'ml' },
            { ingredient: 'butter', amount: 0.25, unitOfMeasure: 'cups' },
            { ingredient: 'fine ground black pepper', amount: 1.5, unitOfMeasure: 'table spoons' },
    ...
    },
    {
        ...
        description: "This recipe serves approximately 8 people. I wanted to replicate a brisket from a good old fashion smoker but I didn't have the space so I thought to try a slow cooker and here are the results!",
        ingredients: [
            {
